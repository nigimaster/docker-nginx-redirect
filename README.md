...
With `docker`    
    ...
    docker run -e SERVER_REDIRECT=localhost -p 8888:80 nigi/nginx-redirect
    docker run -e SERVER_REDIRECT=localhost -e SERVER_REDIRECT_PATH=/landingpage -p 8888:80 nigi/nginx-redirect
    docker run -e SERVER_REDIRECT=localhost -e SERVER_REDIRECT_PATH=/landingpage -e SERVER_REDIRECT_SCHEME=https -p 8888:80 nigi/nginx-redirect
